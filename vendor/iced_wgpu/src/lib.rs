...
impl Renderer {
    ...
    pub fn screenshot(
        ...
        let mapped_buffer = slice
            .get_mapped_range()
            .expect("mapped screenshot buffer");
    ...
    async fn new(
        ...
        let (device, queue) = adapter
            .request_device(&wgpu::DeviceDescriptor {
                ...
                required_features: crate::gpu::ray_query_features(&adapter),
                required_limits: crate::gpu::device_limits(
                    &adapter,
                    wgpu::Limits {
                        max_bind_groups: 2,
                        ..wgpu::Limits::default()
                ...
                experimental_features: crate::gpu::experimental_features(
                    &adapter,
                ),
            })
            .await
