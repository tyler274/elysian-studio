...
impl Atlas {
    ...
    fn upload_allocation(
        ...
        let mut fragment = buffer_slice.get_mapped_range_mut().expect("mapped staging belt");
        ...
        for row in 0..pad_h {
            ...
            for i in 0..pad_w {
                ...
                fragment
                    .slice(
                        dst_bottom + PIXEL * i..dst_bottom + PIXEL * (i + 1),
                    )
