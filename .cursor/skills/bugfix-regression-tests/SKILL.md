...
- Put the test next to the behavior: `elysian-gpu` for viewport/cull/pack, `elysian-model` for plates/volumes, `elysian-protocol` for MQTT/HTTP, GUI goldens only for visible chrome.
