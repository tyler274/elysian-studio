...
use elysian_config::{config_block_gcode, expand_placeholders, PlaceholderContext};
use elysian_geom::{unscale, Point};
...
impl Writer<'_> {
    pub(crate) fn emit_header(&mut self, max_z: f64) -> Result<(), GcodeError> {
        ...
        writeln!(self.out, "; generated by elysian-cli (safe-Rust rewrite)")?;
